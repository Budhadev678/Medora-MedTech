...
export const SEEDED_DOCTOR_SESSIONS: DoctorWorkingSession[] = [
  ...
  // 12. Dr. Ananya Sharma (DOC-1001) @ City Hospital — Rourkela Trauma Center (FAC-1002) — Thursday Morning
  {
    id: "SES-1012",
    doctor_id: "DOC-1001",
    doctor_name: "Dr. Ananya Sharma",
    organization_id: "11111111-1111-1111-1111-111111111101",
    organization_identifier: "HSP-1001",
    organization_name: "City Hospital — Rourkela Trauma Center",
    ...
    capacity: 12,
    room_number: "OPD Room 102",
    session_name: "Visiting Cardiology Clinic",
    is_active: true,
    created_at: "2026-01-01T08:00:00Z",
  },
  // 13. Dr. Priya Das (DOC-1003) @ City Hospital — Bhubaneswar (FAC-1001) — Wednesday Morning
  {
    id: "SES-1013",
    doctor_id: "DOC-1003",
    doctor_name: "Dr. Priya Das",
    organization_id: "11111111-1111-1111-1111-111111111101",
    organization_identifier: "HSP-1001",
    organization_name: "City Hospital — Bhubaneswar Main Campus",
    facility_id: "FAC-1001",
    ...
    start_time: "10:00",
    end_time: "14:00",
    slot_display_time: "10:00 AM - 02:00 PM",
    capacity: 10,
    room_number: "OPD Room 105",
    session_name: "Surgical Outpatient Clinic",
    is_active: true,
    created_at: "2026-01-01T08:00:00Z",
  },
  // 14. Dr. Priya Das (DOC-1003) @ City Hospital — Rourkela (FAC-1002) — Friday Morning
  {
    id: "SES-1014",
    doctor_id: "DOC-1003",
    doctor_name: "Dr. Priya Das",
    ...
    slot_display_time: "10:00 AM - 02:00 PM",
    capacity: 10,
    room_number: "OPD Room 202",
    session_name: "Trauma & Surgical Outpatient Clinic",
    is_active: true,
    created_at: "2026-01-01T08:00:00Z",
  },
  // 15. Dr. Rajesh Sharma (DOC-1002) @ City Hospital — Rourkela (FAC-1002) — Saturday Morning
  {
    id: "SES-1015",
    doctor_id: "DOC-1002",
    doctor_name: "Dr. Rajesh Sharma",
    ...
    session_name: "General Medicine Weekend Clinic",
    is_active: true,
    created_at: "2026-01-01T08:00:00Z",
  },
  // 16. Dr. Ananya Sharma (DOC-1001) @ City Hospital — Bhubaneswar (FAC-1001) — Sunday Consultation
  {
    id: "SES-1016",
    doctor_id: "DOC-1001",
    doctor_name: "Dr. Ananya Sharma",
    ...
    start_time: "10:00",
    end_time: "12:00",
    slot_display_time: "10:00 AM - 12:00 PM",
    capacity: 8,
    room_number: "OPD Room 102",
    session_name: "Sunday Cardiology Clinic",
    is_active: true,
    created_at: "2026-01-01T08:00:00Z",
  },
  // 17. Dr. Rajesh Sharma (DOC-1002) @ City Hospital — Bhubaneswar (FAC-1001) — Sunday Consultation
  {
    id: "SES-1017",
    doctor_id: "DOC-1002",
    doctor_name: "Dr. Rajesh Sharma",
    ...
    start_time: "09:00",
    end_time: "11:00",
    slot_display_time: "09:00 AM - 11:00 AM",
    capacity: 10,
    room_number: "OPD Room 101",
    session_name: "Sunday General Medicine Clinic",
    is_active: true,
    created_at: "2026-01-01T08:00:00Z",
  },
