...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    // Hospital, Emergency, Pharmacy, Lab, Blood Bank Workspaces
    "hospital.title": "Hospital Operations Command Center",
    "hospital.admissions": "Inpatient Admissions & Ward Beds",
    "hospital.occupancy": "Bed Occupancy Rate",
    "hospital.command_center": "Command Center",
    "hospital.departments": "Clinical Departments",
    "hospital.doctors": "Doctor Roster",
    "pharmacy.intake": "Prescription Intake Queue",
    "pharmacy.dispense": "Dispense Medication",
    "pharmacy.fefo": "FEFO Batch Inventory",
    "pharmacy.preparation": "Order Preparation",
    "pharmacy.pickup": "Ready for Pickup",
    "lab.testing_desk": "Diagnostic Testing Desk",
    "lab.sample_custody": "Sample Custody Desk",
    "lab.report_verification": "Report Verification Desk",
    "lab.released_reports": "Released Reports",
    "blood.title": "Hospital Blood Transfusion Centre",
    "blood.urgent_requests": "Urgent Blood Requests",
    "blood.inventory": "Component Inventory",
  ...
  hi: {
    ...
    // Hospital, Emergency, Pharmacy, Lab, Blood Bank Workspaces
    "hospital.title": "अस्पताल संचालन कमांड सेंटर",
    "hospital.admissions": "भर्ती एवं वार्ड बिस्तर",
    "hospital.occupancy": "बिस्तर उपयोग दर",
    "hospital.command_center": "कमांड सेंटर",
    "hospital.departments": "नैदानिक विभाग",
    "hospital.doctors": "डॉक्टर रोस्टर",
    "pharmacy.intake": "नुस्खा स्वीकृति कतार",
    "pharmacy.dispense": "दवा वितरण करें",
    "pharmacy.fefo": "एफईएफओ बैच इन्वेंटरी",
    "pharmacy.preparation": "दवा तैयारी",
    "pharmacy.pickup": "पिकअप हेतु तैयार",
    "lab.testing_desk": "जांच एवं परीक्षण डेस्क",
    "lab.sample_custody": "नमूना अभिरक्षा डेस्क",
    "lab.report_verification": "रिपोर्ट सत्यापन डेस्क",
    "lab.released_reports": "जारी रिपोर्ट",
    "blood.title": "अस्पताल रक्त बैंक एवं आधान केंद्र",
    "blood.urgent_requests": "अति-आवश्यक रक्त मांग",
    "blood.inventory": "रक्त घटक इन्वेंटरी",
  ...
  or: {
    ...
    // Hospital, Emergency, Pharmacy, Lab, Blood Bank Workspaces
    "hospital.title": "ଡାକ୍ତରଖାନା କାର୍ଯ୍ୟାଳୟ କମାଣ୍ଡ ସେଣ୍ଟର",
    "hospital.admissions": "ଭର୍ତ୍ତି ଏବଂ ୱାର୍ଡ ବେଡ୍",
    "hospital.occupancy": "ବେଡ୍ ବ୍ୟବହାର ହାର",
    "hospital.command_center": "କମାଣ୍ଡ ସେଣ୍ଟର",
    "hospital.departments": "ଚିକିତ୍ସା ବିଭାଗ",
    "hospital.doctors": "ଡାକ୍ତର ତାଲିକା",
    "pharmacy.intake": "ଔଷଧ ପ୍ରେସକ୍ରିପସନ୍ ଧାଡ଼ି",
    "pharmacy.dispense": "ଔଷଧ ପ୍ରଦାନ କରନ୍ତୁ",
    "pharmacy.fefo": "FEFO ବ୍ୟାଚ୍ ଇନଭେଣ୍ଟୋରୀ",
    "pharmacy.preparation": "ଔଷଧ ପ୍ରସ୍ତୁତି",
    "pharmacy.pickup": "ନେବା ପାଇଁ ପ୍ରସ୍ତୁତ",
    "lab.testing_desk": "ପରୀକ୍ଷଣ ଡେସ୍କ",
    "lab.sample_custody": "ନମୁନା ସଂଗ୍ରହ ଡେସ୍କ",
    "lab.report_verification": "ରିପୋର୍ଟ ଯାଞ୍ଚ ଡେସ୍କ",
    "lab.released_reports": "ପ୍ରକାଶିତ ରିପୋର୍ଟ",
    "blood.title": "ଡାକ୍ତରଖାନା ରକ୍ତ ଭଣ୍ଡାର ଓ ଟ୍ରାନ୍ସଫ୍ୟୁଜନ୍ କେନ୍ଦ୍ର",
    "blood.urgent_requests": "ଜରୁରୀ ରକ୍ତ ଆବଶ୍ୟକତା",
    "blood.inventory": "ରକ୍ତ ଉପାଦାନ ଇନଭେଣ୍ଟୋରୀ",
