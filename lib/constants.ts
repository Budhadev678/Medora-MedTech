...
export const ROLE_LABELS: Record<UserRole, string> = {
  ...
  lab_staff: "Laboratory Diagnostic Workspace",
  pharmacy_staff: "Pharmacy Dispensing Desk",
  emergency_staff: "Emergency Trauma Unit",
  blood_staff: "Blood Centre Coordinator",
  finance_staff: "Healthcare Finance & Billing",
  insurance_staff: "Insurance & Claims Desk",
  government_staff: "Government Assistance Desk",
  ambulance_staff: "Ambulance Emergency Dispatch",
  staff: "Healthcare Staff Workspace",
...
export const NAVIGATION_LINKS = [
  ...
  { name: "Emergency Unit", href: "/emergency", role: "emergency_staff" },
  { name: "Blood Centre", href: "/blood-bank", role: "blood_staff" },
  { name: "Billing & Finance", href: "/finance", role: "finance_staff" },
