...
const { AccessEngine } = require("./lib/services/access-engine");
const { getPatientConsents, grantConsentRequest, revokeConsent } = require("./lib/data/consent-store");
const { submitCorrectionRequest, getPatientCorrectionRequests } = require("./lib/data/correction-store");
const { logAuditEvent, getPatientAuditTimeline } = require("./lib/data/audit-store");
